  ...
  return (
    <div className='bg-[#08090B] pb-[40px] md:pb-[60px] lg:pb-[90px] xl:pb-[120px] 2xl:pb-[150px] pt-[25px] md:pt-[30px] lg:pt-[40px] xl:pt-[50px] 2xl:pt-[64px]'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[18px] lg:gap-[25px] px-[24px] sm:px-[0] feature mx-5'>
                    <div className='col-span-1 '>
                        <div className="relative overflow-hidden bg-[#0F1012]">
                            <div className="relative group svg-container">
                                <span className='VERIFICATION text-[28px] md:text-[20px] lg:text-[24px] xl:text-[28px] 2xl:text-[32px] !w-full absolute left-[50%] top-[50%] transform -translate-x-[22%] -translate-y-[50%] transition-transform duration-300 ease-in-out !text-[#FEFFFF]'>Sky Challenge</span>
                            ...
                            <div className='px-[20px] sm:px-[25px] lg:px-[32px]'>
                                ...
                                <p className='verifyyour mt-[14px] md:mt-[16px] lg:mt-[18px] xl:mt-[20px] 2xl:mt-[24px]'>Verify your skills under easier trading objectives. upon passing, you become a sky trader and get access to receive an exclusive monthly salary.</p>
                            </div>
                            ...
                            <ul className='flex flex-col w-full px-[20px] sm:px-[25px] lg:px-[32px] pb-[25px] lg:pb-[30px] xl:pb-[35px] 2xl:pb-[40px] gap-[20px] sm:gap-[25px] lg:gap-[32px]'>
                                ...
                                <circle cx="20" cy="20" r="19.5" stroke="white" strokeOpacity="0.08"/>
                    ...
                    <div className='col-span-1 '>
                        <div className="relative overflow-hidden bg-[#0F1012]">
                            <div className="relative group ">
                                <span className='VERIFICATION text-[28px] md:text-[20px] lg:text-[24px] xl:text-[28px] 2xl:text-[32px] !w-full absolute left-[50%] top-[50%] transform -translate-x-[22%] -translate-y-[50%] transition-transform duration-300 ease-in-out'>VERIFICATION</span>

                                <svg width="100%" className='h-[112px] 2xl:h-[132px]' viewBox="0 0 523 132" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.4102 -58.1707L532.39 -25.5229L530.58 3.42051C526.813 63.6426 524.93 93.7537 505.051 111.292C485.172 128.831 455.061 126.947 394.839 123.181L128.36 106.513C68.1379 102.747 38.0268 100.863 20.4884 80.9847C2.94989 61.1059 4.83321 30.9949 8.59986 -29.2272L10.4102 -58.1707Z" fill="#C0FC04" fillOpacity="0.2"/>
                    ...
                    <div className='col-span-1 '>
                        <div className="relative overflow-hidden bg-[#0F1012] ">
                            <div className="relative group ">
                                <span className='VERIFICATION  text-[28px] md:text-[20px] lg:text-[24px] xl:text-[28px] 2xl:text-[32px] !w-full absolute left-[50%] top-[50%] transform -translate-x-[22%] -translate-y-[50%] transition-transform duration-300 ease-in-out !text-[#FEFFFF]'>VERIFICATION</span>
                                ...
                                <path d="M5.87797 -65.6407L526.86 -33.0554L525.081 -4.61094C523.197 25.5142 521.786 48.0578 518.367 65.265C514.952 82.458 509.545 94.2491 499.72 102.917C489.896 111.585 477.523 115.48 460.038 116.727C442.539 117.975 419.996 116.566 389.87 114.681L123.391 98.0142C93.266 96.1299 70.7224 94.7189 53.5152 91.3004C36.3223 87.8848 24.5311 82.4781 15.8633 72.6537C7.19546 62.8292 3.30009 50.4563 2.05343 32.9717C0.805726 15.4726 2.21468 -7.07109 4.09889 -37.1962L5.87797 -65.6407Z" stroke="white" strokeOpacity="0.08"/>
            ...
            <div className='flex flex-col justify-center items-center mt-[5%] '>
              <button className='buttonpage6  '>START TRADING
                </button>
            </div>
