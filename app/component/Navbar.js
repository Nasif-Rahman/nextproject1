...
const NavBar = () => {
  ...
  return (
    <div className='relative z-30 items-center mx-15'>
      <header className='backgrnd1 container mx-auto flex justify-between items-center py-[18px] sm:py-[24px] relative px-[24px] sm:px-[18px] md:px-[22px] lg:px-[26px] xl:px-[28px] 2xl:px-[32px]'>
        ...
        <Link href="*" className='Froggo-Logo w-[50.926px] 2xl:w-[86px]'>
          <Image src={logo} alt='' />
        </Link>
        ...
        `}>
          ...
          <Link className='Link-manu-bar flex justify-center items-center gap-[7px] lg:gap-[10px]' href="#Relations">
            More
